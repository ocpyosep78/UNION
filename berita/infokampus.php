...
<div id="tubes_wrapper">
    ...
    <div id="tubes_page_intro">
        ...
        <p align="justify">Menampilkan seluruh berita dalam kategori Seputar Kampus</p>
    </div>
    ...
    <div id="tubes_main">
    	<div id="tubes_content" class="left">
            <h2>List Berita</h2>
                ...
                ?>    
                <?php
                $sql = "SELECT * FROM tb_berita WHERE brt_kategori='Berita Kampus'";
		...
		<div id="tubes_sidebar" class="right">
            ...
            <div class="sidebar_section sidebar_section_bg">
                ...
                <ul class="sidebar_link_list">
                    ...
                    <li><a href="#"><b>Seputar Kampus</a></b></li>
