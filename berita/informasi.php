...
<div id="tubes_wrapper">
    ...
    <div id="tubes_page_intro">
        ...
        <p align="justify">Menampilkan seluruh berita dalam kategori Informasi</p>
    </div>
    ...
    <div id="tubes_main">
    	<div id="tubes_content" class="left">
            <h2>List Berita</h2>
                ...
                ?>    
                <?php
                $sql = "SELECT * FROM tb_berita WHERE brt_kategori='Informasi'";
