<div id="tubes_header">
<div id="site_title"><a rel="nofollow" href="index.php">UNION</a></div>
    	<div id="tubes_menu" class="ddsmoothmenu">
            <ul>
                <li><a href="../index.php">Beranda</a></li>
                <li><a href="../about.php">Profil</a>
                <ul>
                    <li><a href="../about.php">Kerjasama</a></li>
                    <li><a href="../staff.php">Staff Dosen & Karyawan</a></li>
                </ul>
                <li><a href="../prodi/prodi.php">Prodi</a>
                    <ul>
                        <li><a href="../prodi/prodi.php">List Program Studi</a></li>
