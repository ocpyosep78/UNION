<h3>Admin Panel</h3>
                <ul class="sidebar_link_list">
                    <li><a href="#" onclick="toggle('node1')">Panel Berita</a>
                        <ul id="node1" style="display:none">
                            <li><a href="../berita/create_news.php">Buat berita baru</a></li>
                            <li><a href="../berita/news_list.php">Lihat List Berita</a></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="toggle('node2')">Panel Kurikulum</a>
                        <ul id="node2" style="display:none">
                            <li><a href="../prodi/kurikulum_list.php">List Kurikulum</a></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="toggle('node3')">Panel Galeri</a>
                        <ul id="node3" style="display:none">
                            <li><a href="../admin/list_galeri.php">List Galeri</a></li>
                        </ul>
                    </li>
                    <li><a href="#" onclick="toggle('node4')">Panel Staff dan Karyawan</a>
                        <ul id="node4" style="display:none">
                            <li><a href="../admin/list_staff.php">List staff & Karyawan</a></li>
                        </ul>
                    </li>
