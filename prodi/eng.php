...
<div id="tubes_wrapper">
    ...
    <div id="tubes_main">
        <div id="tubes_content" class="left">
                ...
                <table align="center">
                    <tr>
                        ...
                        <th><a href="#" class="kurmore2">Sastra Inggris</a></th>
                    </tr><tr>
        ...
        <?php
            ...
            WHERE kur_semester = '1' AND kur_prodi = 'Sastra Inggris'";
       ...
       <h3>Semester : II</h3>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '2' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '3' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '4' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '5' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '6' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '7' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
        ...
        <?php
            $sql = "SELECT * FROM tb_kurikulum             
            WHERE kur_semester = '8' AND kur_prodi = 'Sastra Inggris'";
            foreach ($dbh->query($sql) as $data) :
        ?>
            <tr>
                <td><?php echo "$data[kur_id]";?></d>
