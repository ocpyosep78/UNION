...
<div id="tubes_wrapper">
    ...
    <div id="tubes_main">
        <div id="tubes_content" class="left">
            <h2>Program Studi Pariwisata</h2>
            <center><img class="img_border_b img_nom" src="../prodi/images/prodi/001.jpg" alt="Post Image" /></center>
            <p align="justify">
              <b>Akreditasi</b><br>
             A (Sangat Baik) berdasarkan SK BAN-PT Nomor 022 Tahun 2012 berlaku hingga 27 Juli 2007.<br><br>
             <b>Gelar Lulusan</b><br>
             Sarjana Pendidikan (S.Par.)<br><br>
             <b>Deskripsi</b><br>
             Program Studi (prodi) Pendidikan Pariwisata adalah salah satu program studi yang ada di Jurusan Pariwisata 
             Universitas Ontario, merupakan cikal bakal berdirinya Jurusan Pariwisata. 
             Prodi ini telah ada sejak tahun 1980 dan mendapat SK Dikti 1996, yang dipimpin oleh seorang ketua program studi (kaprodi).
             Kurikulum Prodi Pendidikan Pariwisata menawarkan sejumlah mata kuliah wajib dan pilihan minimal 144 SKS dan maksimal 163 SKS.<br><br>
             <b>Peluang Kerja:</b><br/>
                Pengajar di kursus perhotelan<br>
                Konsultan bahasa Prancis<br>
                Pemandu wisata<br>
            </p>

            <a href="../prodi/par_cur.php" class="kurmore2">List Kurikulum</a>
